...
#     # OpenSSL::BN.from_hex(priv)

#     # display private key: #to_hex.rjust(64, '0')


#     # Bitcoin::OpenSSL_EC.regenerate_key(priv)[1] -> https://github.com/lian/bitcoin-ruby/blob/master/lib/bitcoin/key.rb#L244
#   end
